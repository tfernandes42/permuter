...
public class FSCensusPermuterTest {

	@Test
	public void testPermute() {
		File xmlFile = new File("/Users/tfernandes/Desktop/permuterProject/fsObits/censusDoc1.xml");
		...
		FSCensusPermuter thePermuter = new FSCensusPermuter();
